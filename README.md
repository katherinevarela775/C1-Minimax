...
Introducción y Reto:
 ...
 Modo IA vs IA: El sistema permite observar en tiempo real cómo las dos IAs compiten, con un retraso programado (time.sleep) para apreciar el análisis de cada turno.
